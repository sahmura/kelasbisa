                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                ...
                                                                <p>Hai, {{ $user->name }}</p>
                                                                <p>Terima kasih telah mendaftar di Kelas Bisa. Untuk
                                                                    melanjutkan proses belajar dan akses kelas yang ada,
                                                                    silahkan konfirmasi email ini dengan cara klik
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#5E72E4"
                                                                        role="presentation"
                                                                        style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#5E72E4;"
                                                                        valign="middle">
                                                                        <a href="{{ url('user/activate/' . $user->email .'/' . $validation->tokens) }}"
                                                                            style="display:inline-block;background:#5E72E4;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;">
                                                                            Validasi Email </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#637381;">
                                                                <p>Setelah validasi email, kamu akan mendapatkan akses
                                                                    kelas tanpa batas untuk berbagai bidang ilmu. Jika
                                                                    ada kesulitan, jangan sungkan untuk menghubungi
                                                                    kami.</p>
                                                            </div>
                                                        </td>
                                                    </tr>
